...
@RocketMQMessageListener(topic = RocketMqConstant.CONTENT_ESSAY_DELETE_TOPIC,
        consumerGroup = RocketMqConstant.CONTENT_ESSAY_DELETE_TOPIC)
@Slf4j
    ...
    public void onMessage(String message) {
        try {
            ...
            if (delete.result().equals(Result.NotFound)) {
                ...
                throw new TicsException(ExceptionResponseEnum.SHOW_FAIL.setMsg("essay does not exist, stop deleting"));
            }else {
