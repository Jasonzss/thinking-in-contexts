 ...
 */
@Component("audio")
public class AudioRecommender implements ContentRecommender {

    public static final String DEFAULT_PREFERENCE_TABLE = "audio_taste_preferences";
