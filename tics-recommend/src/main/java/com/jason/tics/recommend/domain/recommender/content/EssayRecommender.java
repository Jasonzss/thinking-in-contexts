 ...
 */
@Component("essay")
public class EssayRecommender implements ContentRecommender {

    public static final String DEFAULT_PREFERENCE_TABLE = "essay_taste_preferences";
    ...
    @Autowired
    public EssayRecommender(DataSource dataSource)  {
